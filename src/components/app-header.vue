<template>
  <m-navbar :theme="theme.theme.headerTheme">
    ...
    <m-nav>
      <m-nav-item><router-link to='/'>首页</router-link></m-nav-item>
    </m-nav>
    <m-nav align="right">
...
export default {
  ...
  //刷新token
    ...
    //   }
    //   const paramtoken = { refreshToken: localStorage.getItem('刷新token') }
    //    const axios = require('axios');
    //  axios.post('http://retail.caidj.cn/api/refresh', paramtoken, refresh).then(res => {
