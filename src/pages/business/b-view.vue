...
<el-container class="app-container"
  ...
  <el-aside class="app-side" :width="hideSide ? '0' : sideWidth + 'px'"
    ...
    <div class="app-header-logo-box"
      ...
      <span class="header-logo-text"><router-link class='control' style="color:black;" :to="{path: '/'}">控制台</router-link></span>
    </div>
...
import AppHeader from '@/pages/business/b-header'
import AppFooter from '@/pages/business/b-footer'
import AppSide from '@/pages/business/b-side'
export default {
  name: 'app-view',
  data () {
    return {
